...
Acteur* lireActeur(istream& fichier, ListeFilms* liste)
{
	...
	if (trouverActeur(liste, acteur.nom) != nullptr) {
		...
		cout << "j'ai créer un nouvel acteur" << acteur.nom << endl;
...
ListeFilms creerListe(string nomFichier)
{
	...
	liste.nElements = nElements;
	liste.elements = new Film*[nElements];
	for (int i = 0; i < nElements; i++) {
		(liste.elements)[i] = lireFilm(fichier, &liste); //TODO: Ajouter le film à la liste.
	}
...
int main()
{
	...
	ListeFilms listeFilms = creerListe("/Users/allankamta/CLionProjects/Debut_en_C++/TP_INF_1015/TP2/TD2-H25-Fichiers/films.bin");
